let createAdaptiveFilters = function (gridId, param, usernameSession) {
    ...
    return {
        ...
        showDialog: function (columnId, usernameSession) {
            if (!modal[columnId]) {
                ...
                $.post(url, { columnId, usernameSession }, function (response) {
