let createCrud = function (crudParam) {
    ...
    // initiate grid
    initGrid(gridId, controllerName, crudParam.gridConfig.size, crudParam.gridConfig.orderBy, crudParam.usernameSession);
    ...
    function showReadonlyForm(id) {
        clearForm("#ModalForm");
        $("#ModalForm").modal('show');
        $.get('/phe_xplore/Explorationstructure/Detail' + "/" + id, function (partialviewEXP) {
            $("#ModalForm .append-here").html($(partialviewEXP));
        })
        //$.get('/ExplorationStructure/Detail' + "/" + id, function (partialView) {
        //    $("#ModalForm .append-here").html($(partialView));
        //})
    }
    function showReadonlyFormESDC(id) {
        clearForm("#ModalForm");
        $("#ModalForm").modal('show');
        $.get('/phe_xplore/ESDC/DetailESDC' + "/" + id, function (partialView) {
            $("#ModalForm .append-here").html($(partialView));
        })
        //$.get('/ESDC/DetailESDC' + "/" + id, function (partialView) {
        //    $("#ModalForm .append-here").html($(partialView));
        //})
    }
