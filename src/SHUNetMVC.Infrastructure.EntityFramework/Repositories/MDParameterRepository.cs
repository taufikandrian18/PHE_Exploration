...
{
    public class MDParameterRepository : BaseCrudRepository<MD_Paramater, MDParameterDto, MDParameterDto, MDParameterQuery>, IMDParameterRepository
    {
        public MDParameterRepository(DB_PHE_ExplorationEntities explorationContext, IConnectionProvider connection, DB_PHE_HRIS_DEVEntities hrContext)
                : base(explorationContext, connection, new MDParameterQuery(), hrContext)
        {
